document.addEventListener("DOMContentLoaded", async () => {
    let wonMatchesAndToss = await fetch("http://localhost:3000/teamsWonMatchAndToss", {
    ...
    Highcharts.chart("container5", {
      ...
      title: {
        text: '<span style="font-size:20px;font-weight:bold;">Number of Matches Team Won Toss as well as Match</span>',
      },
