...
const createTableForDeliveriesQuery = `CREATE TABLE deliveries(match_id INT NOT NULL,inning INT,batting_team varchar(50),
...
const insertIntoMatchesTableQuery = `LOAD DATA LOCAL INFILE './../data/matches.csv'
